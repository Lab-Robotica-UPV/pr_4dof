...
def generate_launch_description():
    ...
    pr_pdg = ComposableNodeContainer(
            ...
            composable_node_descriptions=[
                ...
                ComposableNode(
                    package='pr_aux',
                    node_plugin='pr_aux::ReplayerPosForce',
                    node_name='replayer_pos_force',
                    remappings=[
                        ("data_pos", "joint_position"),
                        ("data_force", "force_state"),
                        ("end_flag", "end_flag")
                    ],
                    parameters=[
                        {"ts_ms": controller_params['ts']*1000},
                        {"data_path_pos": "/home/paralelo4dofnew/ros2_eloquent_ws/pr_4dof/replay/med_qinde_TRR18_CF1_V1.txt"},
                        {"data_path_force": "/home/paralelo4dofnew/ros2_eloquent_ws/pr_4dof/replay/med_Fent_TRR18_CF1_V1.txt"}
                    ]
                ),
            ],
            output='screen',
