...
def generate_launch_description():
    ...
    pr_pdg = ComposableNodeContainer(
            ...
            composable_node_descriptions=[
                ...
                ComposableNode(
                    package='pr_modelling',
                    node_plugin='pr_modelling::AdaptiveRBFGNN',
                    node_name='adaptive_rbfg_nn',
                    remappings=[
                        ("ref_pos", "ref_pose"),
                        ("pos", "joint_position"),
                        ("Tau_adaptw", "Tau_adaptw")
                    ],
                    parameters=[
                        {"ts": data['general']['ts']},
                        {"c_gain": 10.0},
                        {"gama_rbf": 900.0},
                        {"c_festo": [-2.0, -1.0, 0.0, 1.0, 2.0]},
                        {"c_niasa": [-2.0, -1.0, 0.0, 1.0, 2.0]},
                    ]
                ),
                ...
                ComposableNode(
                    ...
                    remappings=[
                        ...
                        ("joint_velocity", "joint_velocity"),
                        ("q_grav", "q_grav"),
                        ("control_action", "actions_pdg")
                    ],
                    parameters=[
                        {"kp_gain": controller_params['controller']['kp']}, #{"kp_gain": [8542.5652, 8542.5652, 8542.5652, 13692.4150]},
                        {"kv_gain": controller_params['controller']['kv']}, #{"kv_gain": [212.59, 212.59, 212.59, 270.68]},
                ...
                # ComposableNode(
                #     package='pr_sensors_actuators',
                #     node_plugin='pr_sensors_actuators::EncodersSim',
                #     node_name='position_sensors_sim',
                #     remappings=[
                #         ("joint_position", "joint_position")
                #     ],
                #     parameters=[
                ...
                #         {"initial_position": data['general']['init_q']},
                #         {"enc_path":  "/home/paralelo4dofnew/SharedFolder/Trayectorias/Lotfy/ref_qinde_med_simTRR17_5P_CF1.txt"}
                #     ]
                # ),     
