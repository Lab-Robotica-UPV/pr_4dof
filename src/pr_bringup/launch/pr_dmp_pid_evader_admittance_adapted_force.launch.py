            ...
            composable_node_descriptions=[
                ...
                ComposableNode(
                    ...
                    remappings=[
                        ...
                        ("force_traj_init","ref_force_init"),
                        ("force_traj_changed","ref_force"),
                    ],
                    parameters=[
                        {"ts": data['general']['ts']},
                        ...
                        {"damping_coefficient_force": [3.0, 3.0, 3.0, 3.0]},
                        {"spring_constant_force": [1.0, 1.0, 1.0, 1.0]},
                        {"mass_force": [2.25, 2.25, 2.25, 2.25]},
