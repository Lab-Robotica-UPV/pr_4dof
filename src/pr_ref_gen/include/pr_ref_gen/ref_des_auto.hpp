#ifndef PR_REF_GEN__REF_DES_AUTO_HPP_
#define PR_REF_GEN__REF_DES_AUTO_HPP_
...
{
    class RefDesAuto : public rclcpp::Node
    {
        public:
            //PR_REF_GEN_PUBLIC
            explicit RefDesAuto(const rclcpp::NodeOptions & options);
        ...
        private:
            ...
            // Increments in Configuration space
            std::vector<double> des_x_set;

    };
}

#endif // PR_REF_GEN__REF_DES_AUTO_HPP_