#ifndef PR_DMP__REVERSIBLE_HPP_
#define PR_DMP__REVERSIBLE_HPP_
...
namespace pr_dmp
{
    class DmpRev : public rclcpp::Node
    {
        public:
            //PR_AUX_PUBLIC
            explicit DmpRev(const rclcpp::NodeOptions & options);
            ~DmpRev();
        ...
        private:
            ...
            bool end_task = false;
            // Forward signal for the progress of the DMP
            double forward = 1.0;
            ...
            VectorXd phase_current = VectorXd::Zero(1);
