#ifndef PR_DMP__REVERSIBLE_FORCE_LIM_HPP_
#define PR_DMP__REVERSIBLE_FORCE_LIM_HPP_
...
namespace pr_dmp
{
    class DmpRevFLim : public rclcpp::Node
    {
        public:
            //PR_AUX_PUBLIC
            explicit DmpRevFLim(const rclcpp::NodeOptions & options);
            ~DmpRevFLim();
        ...
        private:
            ...
            //Iniial pose in the trajectory
            Eigen::Vector4d ref_pos_init;
            //Time instant to allow control the trajectory using the force limit
            double t_user_ctrl=-1.0;
            // Flag for first transition to the patint
            bool flag_user_ctrl = false;
...
#endif // PR_DMP__REVERSIBLE_FORCE_LIM_HPP_